  ...
  return (
    ...
    >
      ...
      <section className="space-y-4">
        ...
        <h3 className="text-[18px] font-grandstander font-bold text-[#333]">3.4 Limited Return/Exchange Categories:</h3>
        ...
        <h3 className="text-[18px] font-grandstander font-bold text-[#333]">3.5 Returns/Exchanges Will Not Be Accepted If:</h3>
        <ul className="list-disc pl-6 space-y-2">
        ...
        <h3 className="text-[18px] font-grandstander font-bold text-[#333]">3.6 Quality Checks and Return/Exchange Processing:</h3>
        ...
        <h3 className="text-[18px] font-grandstander font-bold text-[#333]">3.7 Exclusions:</h3>
        ...
        <h3 className="text-[18px] font-grandstander font-bold text-[#333]">3.8 Status Updates:</h3>
